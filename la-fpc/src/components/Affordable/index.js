      ...
      console.log(this.props.isLogged, 'this is logged')
        return(
          <Container>
            ...
            <ChartDiv>
              <ToolKit>
                  <Button style={{backgroundColor:'#7ED3B1', marginTop:"10px"}} fullWidth>Number of Properties</Button>
                  <Button style={{backgroundColor:'#7ED3B1', marginTop:"10px"}} fullWidth>Grocery Stores</Button>
                  <Button style={{backgroundColor:'#7ED3B1', marginTop:"10px"}} fullWidth>Food Consumption</Button>
                  <Button style={{backgroundColor:'#7ED3B1', marginTop:"10px"}} fullWidth>Obesity Percentage</Button>
                  <Button style={{backgroundColor:'#7ED3B1', marginTop:"10px"}} fullWidth>Health Diagnosis Percentage</Button>
              </ToolKit>
              <ToolKit>
